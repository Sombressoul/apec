...
from models import CIFAR100, CIFAR100Activations

data_path = f"{project_dir}/data"
activation_names = [v.name for v in CIFAR100Activations]
...
def main():
    ...
    parser.add_argument(
        ...
        default="APEC",
        metavar="N",
        help=f"type of activation function ({', '.join(activation_names)}) (default: APEC)",
    )
    parser.add_argument(
        "--plot-loss",
        default=False,
    ...
    model = CIFAR100(
        activation_fn=CIFAR100Activations[args.activation],
    ).to(device)
